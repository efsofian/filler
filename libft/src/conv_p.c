...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/20 19:10:06 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/27 02:23:34 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void	zero(t_printf *env, char *s)
{
...
static void	norme(t_printf *env, char *s)
{
	while (env->size < env->width)
	{
		if (env->moins)
