...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/13 21:54:04 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/27 02:23:27 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char	*flags(unsigned long long o, t_printf *env)
{
	char	*s;
...
static char	*zero(unsigned long long o, t_printf *env)
{
	char	*s;
