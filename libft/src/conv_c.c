...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/08 21:06:47 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/27 02:23:03 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void	ft_putstr_right(unsigned char c, t_printf *env)
{
	int	i;
...
static void	norme(t_printf *env, unsigned char c)
{
	int i;
