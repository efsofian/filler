...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/13 21:27:03 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/27 02:24:11 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char	*flags(unsigned long long x, t_printf *env)
{
	char	*s;
...
static char	*zero_norme(unsigned long long x, t_printf *env, char *s)
{
	if (env->precision)
	{
		while (env->size++ < env->precision)
...
static char	*zero(unsigned long long x, t_printf *env)
{
	char	*s;
