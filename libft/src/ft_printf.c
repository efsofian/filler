...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/06 20:29:59 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/28 08:49:37 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void	ft_init(t_printf *env)
{
	env->diese = 0;
	env->moins = 0;
	env->plus = 0;
...
static void	ft_check_option(char *format, t_printf *env)
{
	ft_init(env);
	env->i++;
...
static int	ft_start(char *format, t_printf *env)
{
	env->i = 0;
