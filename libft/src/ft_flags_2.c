...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/07 05:20:33 by seliasbe          #+#    #+#             */
/*   Updated: 2017/05/27 02:24:48 by seliasbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void	flag_width_norme(char *format, t_printf *env, int i)
{
	char	*str;
...
static void	flag_precision_norme(char *format, t_printf *env, int i)
{
	char	*str;
